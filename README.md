...
| 类型 | 内容 | 数据源 |
|---|---|---|
| 🆕 新模型 | 模型名 · 厂商 · 上下文 · 输入/输出价格 | OpenRouter `/api/v1/models` |
| 💰 价格 | 涨跌幅（本地快照对比，≥5% 才显示） | 同上，`localStorage` 存上次快照 |
| 🔥 热帖 | 标题 · 分数 · 评论数 | HN Algolia API |
| ⭐ 开源 | 新仓库 · 涨星 · 语言 · 简介 | GitHub Search API |
| 🚀 产品 | Product Hunt 当日 AI 产品 | agents-radar 日报 |
| 📄 论文 | arXiv cs.AI/CL/CL 论文 + 今日要点 | agents-radar 日报 |
